...
class DataSupportingDeviceController extends Controller
{
    ...
    public function storeLaboratorySupportingDevice(DataSupportingDeviceRequest $request, LaboratoryRoom $laboratoryRoom)
    {
        ...
        return redirect()->route('dataSupportingDevice.indexInLabour', $laboratoryRoom->id)->with('success', 'Create Data Success');
    }
    ...
    public function updateLaboratorySupportingDevice(DataSupportingDeviceRequest $request, LaboratoryRoom $laboratoryRoom, SupportingDeviceInformation $supportingDeviceInformation)
    {
        ...
        return redirect()->route('dataSupportingDevice.indexInLabour', $laboratoryRoom->id)->with('success', 'Update Data Success');
    }
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            if (!empty($request->from_date)) {
                $data = SupportingDeviceInformation::whereBetween('date', array($request->from_date, $request->to_date))->get();
            } else {
                $data = SupportingDeviceInformation::latest();
            }
        ...
        return view('pages.dataSupportingDevices.index', compact('laboratoryRoom'));
    }
}
