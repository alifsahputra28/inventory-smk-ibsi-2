    ...
    <div class="py-4">
        <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('laboratory-rooms.index') }}">Table: Laboratory Data Supporting Devices</a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">
                    Add Laboratory Supporting Devices
                </li>
            </ol>
        </nav>
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                <h1 class="h4">Table Laboratory Data Supporting Devices</h1>
                <p class="mb-0">Form to add laboratory supporting devices.</p>
            </div>
            <div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="table-laboratory-supporting-device">
                            <thead>
                ...
                <div class="modal-body">
                    <table class="table">
                        ...
                        <tbody>
                           ...
                           <tr class="text-center">
                                <td>{{ $item->name }}</td>
                                <td><a href="{{ route('dataSupportingDevice.create', $item->id) }}" class="btn btn-info">Choice</a></td>
                           </tr>
                            @endforeach
                        </tbody>
                    </table>
...
<script>
    $(document).ready(function(){
        ...
        function load_data(from_date = '', to_date = ''){
            $('#table-laboratory-supporting-device').DataTable({
                processing: true,
                serverSide: true,
                ...
                ajax: {
                    url:"{{ route('dataSupportingDevice.index') }}",
        ...
        $('#filter').click(function(){
            ...
            if(from_date != '' &&  to_date != ''){
                $('#table-laboratory-supporting-device').DataTable().destroy();
